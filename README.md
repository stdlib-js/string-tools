...
```javascript
import tools from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-tools@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { grapheme } from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-tools@v0.2.0-deno/mod.js';
```
